                    ...
                    {cart.map((item) => (
                        ...
                        >
                            ...
                            <div className="grow min-w-0">
                                <Link to={`/teas/${item.id}`} className="text-lg font-semibold text-gray-900 hover:text-emerald-700 truncate block">
                                    {item.name}
                                </Link>
                                <p className="text-sm text-gray-200">{item.origin}</p>
